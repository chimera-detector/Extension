...
function dashboard(id, fData){
      ...
      function segColor(c){ return {clickbait:"#807dba", unrelated:"#e08214", related:"#41ab5d"}[c]; }

      // compute total for each state.
      fData.forEach(function(d){d.total=d.freq.clickbait+d.freq.unrelated+d.freq.related;});
      ...
      var tF = ['clickbait','unrelated','related'].map(function(d){
